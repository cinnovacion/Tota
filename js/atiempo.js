...
function matrixATiempo(level){
	...
	if (level == 2){
		return [
			{"matrix":[9, 2, 3, 4, 6], "resp":19, "first": [10, 13, 15]},
			{"matrix":[2, 8, 10, 10, 5], "resp":25, "first": [15, 20, 50]},
			{"matrix":[7, 5, 2, 8, 1], "resp":11, "first": [10, 12, 13]},
			{"matrix":[10, 2, 4, 2, 4], "resp":10, "first": [6, 8, 12, 14, 20, 40]},
			{"matrix":[8, 10, 1, 10, 10], "resp":17, "first": [18]},
			{"matrix":[3, 6, 2, 4, 8], "resp":96, "first": [48]},
			{"matrix":[4, 9, 10, 6, 7], "resp":630, "first": [63, 90]},
			...
			{"matrix":[10, 5, 2, 2, 2], "resp":25, "first": [20, 50]},
			...
			{"matrix":[10, 6, 2, 10, 1], "resp":2, "first": [8, 12, 20]},
			...
			{"matrix":[600, 100, 52, 3, 6], "resp":1800, "first": [18, 300, 600]},
